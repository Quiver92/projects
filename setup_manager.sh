...
#Title
(tput sc ; tput cup 5 17 ; tput bold ; echo "====================================" ; tput rc)
(tput sc ; tput cup 6 27 ; tput bold ; echo "Menu to Setup" ; tput rc)
(tput sc ; tput cup 7 17 ; tput bold ; echo "====================================" ; tput rc)
#Choices
...
( tput bold ; tput cup 15 5 ; read -p "Enter your choice [1-2]" answer)
